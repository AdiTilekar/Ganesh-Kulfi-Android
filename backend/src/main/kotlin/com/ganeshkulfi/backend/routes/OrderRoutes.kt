        ...
        route("/api/orders") {
            ...
            post {
                try {
                    ...
                    // Get retailer details (in real app, fetch from user table)
                    val retailerName = "Retailer" // TODO: Fetch from user table
                    val shopName = null // TODO: Fetch from user table
